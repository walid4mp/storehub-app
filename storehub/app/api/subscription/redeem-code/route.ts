...
import { findSubscriptionCode } from '@/lib/subscription-codes'
import { redeemSubscriptionCodeForUser } from '@/lib/subscription-helpers'
...
export async function POST(request: Request) {
  try {
    ...
    const matchedCode = findSubscriptionCode(body?.subscriptionCode || '')
