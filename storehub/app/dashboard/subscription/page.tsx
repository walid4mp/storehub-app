...
export default function SubscriptionPage() {
  ...
  const standardFeatures = ['3 قوالب متجر', 'منتجات غير محدودة', 'تجديد شهري تلقائي عبر Stripe', 'يمكن التفعيل أيضًا بكود اشتراك مخصص']
  const proFeatures = ['كل القوالب', 'تحليلات ومظهر احترافي', 'تجديد شهري تلقائي عبر Stripe', 'يمكن التفعيل أيضًا بكود اشتراك مخصص']
